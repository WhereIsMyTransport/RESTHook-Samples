...
public class HmacUtilities {
    ...
    /**
     * @param key the secret which was supplied by the server upon the intial webhook handshake
    ...
    public static boolean validBody(Webhook hook, String body,String xHookSignature){
        try {
